...
\begin{twierdzenie}[O istnieniu i zbieżności średnich]
...
\begin{twierdzenie}[Ergodyczne dla łańcuchów nieokresowych]
...
\begin{twierdzenie}[Równoważność odwracalności i równowagi szczegółowej]
